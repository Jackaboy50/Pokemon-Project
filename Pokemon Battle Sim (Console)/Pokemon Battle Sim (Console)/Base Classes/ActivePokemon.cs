...
namespace Pokemon_Battle_Sim__Console_
{
    public class ActivePokemon : Pokemon
    {
        ...
        public ActivePokemon(string n, string nm, string g, int l, bool s, Item i, int[] b, List<string> pm, List<string> fg, int[] iv, int[] ev, PType T1, PType T2, string N, List<Move> M) : base(n, T1, T2, b, pm, new List<string>(), new List<string>())
        {
            Nickname = nm;
            Gender = g;
            Level = l;
