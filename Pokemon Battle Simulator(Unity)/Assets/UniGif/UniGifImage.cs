...
public class UniGifImage : MonoBehaviour
{
    ...
    private List<List<UniGif.GifTexture>> m_gifTextureListStore;
    // Delay time
    ...
    private void Start()
    {
        ...
        if (m_loadOnStart)
        {
            SetGifFromUrl(m_loadOnStartUrl.ToLower());
        }
    }

    public List<UniGif.GifTexture> GetTextureList()
    {
        return m_gifTextureList;
    }
